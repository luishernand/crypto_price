...
#-------------------------------------#
#Logo
image = Image.open("C:\\Users\\Lenovo\\Documents\\Ciencia de Datos\\streamlit\\crypto_price\\logo.jpg")
...
* **Python libraries:** bs4, pandas, matplotlib, streamlit, BeautifulSoup, requests
* **Data Source:** [CoinMarketCap](http://coinmarketcap.com)
* **Credit:** Web scraper adapted from the Medium article *[Web Scraping Crypto Prices With Python](https://towardsdatascience.com/web-scraping-crypto-prices-with-python-41072ea5b5bf)* written by [Bryan Feng](https://medium.com/@bryanf).
and [dataprofessor](https://github.com/dataprofessor)
    ''')
#---------------------------------------------#
#Page layout
...
## Currency price unit
currency_price_unit = col1.selectbox('Select currency for price', ('USD', 'BTC', 'EHT'))
#---------------------------------------------------#
#webscrapping
@st.cache
def load_data():
...
#-----------------------------------------#
#slider for col1
##sidebar crypto currency selector Col1
sorted_coin = sorted(df['coin_symbol'])
selected_coin = col1.multiselect('Cryptocurrency', sorted_coin, sorted_coin)
df_selected_coin = df[(df['coin_symbol'].isin(selected_coin))]

## col1: sidebar no. of coins
num_coins = col1.slider('Display Top N coins', 1, 100, 100)
df_coins = df_selected_coin[:num_coins]
...
col2.write('Data Dimension:' + str(df_selected_coin.shape[0]) + ''+
    'rows and' + '' + str(df_selected_coin.shape[1]) + ' '+
    'columns.'
    )
